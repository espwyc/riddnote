! function (t) {
    function e(e) {
        for (var o, a, u = e[0], c = e[1], f = e[2], s = 0, p = []; s < u.length; s++) a = u[s], r[a] && p.push(r[a][0]), r[a] = 0;
    ...
    23: function (t, e, n) {
        ...
        var F = new(o = Object(s.a)({
            ...
            M = new(function (t) {
                function e() {
                    ...
                    return (n = w(this, (t = g(e)).call.apply(t, [this].concat(r)))).t = 0, n.update = n.update.bind(j(j(n))), n
                }
                return m(e, u["a"]), d(e, [{
                    key: "update",
                    value: function () {
        ...
        var _ = ["#FDFFFC", "#FDFFFC", "#FDFFFC", "#FDFFFC", "#EA526F", "#71b9f2"].map(function (t) {
                ...
                return m(e, c["a"]), d(e, [{
                    ...
                    value: function () {
                        (y(g(e.prototype), "addLine", this).call(this, {
                            ...
                            color: Object(l.a)(_)
                        }).rotation.x = Object(f.a)(0, 2 * Math.PI), Math.random() > .1) && (y(g(e.prototype), "addLine", this).call(this, {
                            width: Object(f.a)(.05, .1),
                            length: Object(f.a)(5, 10),
                            visibleLength: Object(f.a)(.05, .5),
                            speed: .05,
                            position: new i.Vector3(Object(f.a)(-9, 5), Object(f.a)(-5, 5), Object(f.a)(-10, 6)),
                            color: Object(l.a)(_)
        ...
        C.to(".overlay", .6, {
            ...
            }), e.add(M.hide, 0), e.add(T.stop), e.to(".overlay", .5, {
                autoAlpha: 1,
                onComplete: t
            }, "-=1.5")
        })
